...
namespace Grit.Net.DataAccess.SqlClient
{
    ...
    public class MSSqlGeneralDAL<T> : BaseDAL<T>, IGeneralDAL<T> where T : Entity, new()
    {
        ...
        {
            IDataParameter[] parms = new DbParameter[] { new SqlParameter("@" + IdColomnName, IdValue), ParamFilterInValid };
