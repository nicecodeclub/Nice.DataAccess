...
namespace Grit.Net.Common.DataAccess
{
    ...
    public class DataHelper
    {
        ...
        {
            string ConnString = ConfigHelper.GetConnectionString("dbConnString", null);
            if (ConnString == null)
                throw new ConfigNotImplementException();
            string ProviderName = ConfigHelper.GetConnProviderName("dbConnString", "System.Data.SqlClient");
            string timeOut = ConfigHelper.GetAppSettings("CommandTimeOut", null);
            if (!string.IsNullOrEmpty(timeOut))
                CommandTimeout = int.Parse(timeOut);
            Create(ConnString, ProviderName);
        }
